El archivo de Scraping+MongoDB.py trata de un programa de scrapper hacia la pagina web IMDb en donde se recolecta la informacion necesaria para introducirla en una Base de Datos MongoDB
